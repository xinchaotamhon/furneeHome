...
const userSchema = new mongoose.Schema({
  ...
  districtCode: { type: Number, default: null, min: 1, max: 99999 },
  districtName: { type: String, default: '', trim: true, maxlength: 100 },
  wardCode: { type: Number, default: null, min: 1, max: 999999 },
  wardName: { type: String, default: '', trim: true, maxlength: 100 },
