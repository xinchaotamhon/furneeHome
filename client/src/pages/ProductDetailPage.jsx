  ...
  return <main className="container page detail-page">
    ...
    <section className="detail-grid">
      ...
      <div className="detail-info">
        ...
        {stock > 0 && <div className="detail-action-box"><label>Số lượng<input type="number" min="1" max={stock} value={quantity} onChange={(event) => setQuantity(Math.min(stock, Math.max(1, Number(event.target.value) || 1)))} /></label><button className="button button-outline" type="button" onClick={add}>Thêm vào giỏ</button><button className="button button-accent" type="button" onClick={buyNow}>Mua ngay</button></div>}
