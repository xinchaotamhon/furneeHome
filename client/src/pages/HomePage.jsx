...
export default function HomePage() {
  return (
    <main>
      ...
      <section className="container home-callout"><div><p className="eyebrow">BỘ SƯU TẬP ĐẦY ĐỦ</p><h2>41 sản phẩm nội thất tiện ích cho phòng trọ sinh viên</h2><p>Đã đồng bộ trực tiếp từ CSDL MongoDB và Shopee, sẵn sàng để bạn xem thử vị trí trong phòng bằng AI.</p></div><Link className="button" to="/products">Khám phá ngay</Link></section>
    </main>
  );
}
