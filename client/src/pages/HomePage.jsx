...
export default function HomePage() {
  return (
    <main>
      ...
      <section className="container home-callout"><div><p className="eyebrow">BẢN THỬ HIỆN TẠI</p><h2>10 sản phẩm mẫu để cả nhóm kiểm tra luồng sử dụng</h2><p>Chưa đưa lên MongoDB. Khi dữ liệu thật sẵn sàng, nhóm sẽ thay nguồn dữ liệu mà không phải đổi bố cục trang.</p></div><Link className="button" to="/products">Mở danh sách</Link></section>
    </main>
  );
}
