...
export default function PublicCollectionDetailPage() {
  ...
  return <main className="container page">
    ...
    {design.designMode === 'inspiration' && <p className="privacy-note">Đây là ý tưởng nội thất do AI tạo, không phải các sản phẩm cụ thể trong danh mục. Dùng lại mẫu sẽ giữ ảnh phòng và mô tả để bạn tạo ý tưởng mới.</p>}
