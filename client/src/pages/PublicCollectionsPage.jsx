...
export default function PublicCollectionsPage() {
  ...
  return <main className="container page">
    ...
    <div className="privacy-note"><strong>Chia sẻ có chủ động</strong><span>Chỉ những mẫu mà chủ sở hữu đã bật công khai mới xuất hiện ở đây. Ảnh phòng riêng không được hiển thị ngoài lựa chọn đó.</span></div>
