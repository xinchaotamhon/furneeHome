...
const phoneUrl = 'tel:0372208100';
const email = 'furneehome@gmail.com';
    ...
    <footer className="site-footer fh-footer">
      <div className="container fh-footer-grid">
        ...
        <div>
          ...
          <a href={phoneUrl}>☎ {contactPhone}</a>
      ...
      <div className="fh-contact-float" aria-label="Liên hệ nhanh">
        <a className="fh-contact-float-button fh-phone-float" href={phoneUrl} aria-label={`Gọi ${contactPhone}`}>
